...
> 기획·설계·구현·검증·배포 전 과정의 **연구개발 기록**은 이 문서 하단 [📒 연구개발 기록](#-연구개발-기록-rd-log) 파트에 정리되어 있습니다.
...
> 아래는 기획 → 설계 → 구현 → 검증 → 배포에 이르는 전 과정을 정리한 연구개발 기록입니다.
> (단독 문서 `DEVELOPMENT.md` 와 동일 내용 — 연구노트 작성 시 이 파트를 그대로 활용하세요.)
